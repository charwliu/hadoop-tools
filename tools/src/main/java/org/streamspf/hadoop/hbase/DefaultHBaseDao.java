...
import static org.streamspf.hadoop.hbase.impl.HTableBeanMgr.*;
...
public class DefaultHBaseDao extends AbstractBaseDao {
	...
	@Override
	protected <T> boolean merge(T bean, boolean ifInsertElseUpdate, EnumSet<DaoOption> options) throws HBaseDaoException {
	...
	public <T> void put(String family, Class<T> beanClass, Object rowkey, Object key, Object value, Object[] kvs) throws HBaseDaoException {
		...
		byte[] bfamily = Bytes.toBytes(getDefaultFamily(tableBean, family));
		Put put = new Put(bRowkey);
		createPutKv(tableBean, put, bfamily, key, value, kvs);
		commitPut(tableBean, put);
	}

	private <T> void createPutKv(HTableBean tableBean, Put put, byte[] family, Object key, Object value, Object[] kvs) {
